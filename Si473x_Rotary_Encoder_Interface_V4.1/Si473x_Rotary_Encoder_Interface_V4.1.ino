...
#define BEEPER           12  // To be deleted. My scketch do not have beep
#define displayon         1
#define displayoff        0
#define beepOn            1
#define beepOff           0
...
int Ybutst  =  90 + ytotoffset;  // Y Start location Buttons

int Xsmtr   =   0;
int Ysmtr   =  90 + ytotoffset;  // S meter 85

int XVolInd =   0;
//int YVolInd = 135 + ytotoffset;  // Volume indicator
int YVolInd = 112 + ytotoffset;  // Volume indicator
...
void setup() {
  ...
  Serial.println("Version 4.1 Jan-22-2022");
  tft.setCursor(0, 0);
  tft.println("   SI4735/32 Radio");
  // tft.setCursor(0, 40);
  tft.println("  V4.1 Jan-22-2022");
  tft.setCursor(0, 50);
...
//=======================================================================================
  ...
  // tft.fillRect(Xsmtr + 15, Ysmtr + 38 , (2 + spoint), 6, TFT_RED);  // Delete
  // tft.fillRect(Xsmtr + 17 + spoint, Ysmtr + 38 , 212 - (2 + spoint), 6, TFT_GREEN);  // Delete

  tft.fillRect(Xsmtr + 24, Ysmtr + 11 , (2 + spoint), 6, TFT_RED);
  tft.fillRect(Xsmtr + 26 + spoint, Ysmtr + 11 , 203 - (2 + spoint), 6, TFT_GREEN);
}
...
//=======================================================================================
  ...
  tft.setTextColor(TFT_WHITE, TFT_BLACK);
  tft.setCursor(XVolInd + borderThickness +  5, YVolInd + borderThickness + 5);
  tft.print("Vol");
}
...
//=======================================================================================
  ...
  tft.fillRect(Xsmtr + borderThickness, Ysmtr + borderThickness, 240 - (2 * borderThickness), 22 - (2 * borderThickness), TFT_BLACK);
  tft.setTextColor(TFT_WHITE, TFT_BLACK);
  tft.setCursor(Xsmtr + borderThickness +  5, Ysmtr + borderThickness + 10);
  tft.print("Sig");
  // end Smeter
}
...
//=======================================================================================
  ...
  tft.setCursor(0, 0);
  tft.setTextColor(TFT_YELLOW, TFT_BLACK);
  tft.drawString("SW Ver: V4.1 Jan-22-2022 (p. 1 of 2)",5,10);
  tft.drawString("BY RICARDO - GERT - RXAVIER",5, 20);
  tft.setTextColor(TFT_WHITE, TFT_BLACK);
  ...
  tft.setCursor(0, 0);
  tft.setTextColor(TFT_YELLOW, TFT_BLACK);
  tft.drawString("SW Ver: V4.1 Jan-22-2022 (p. 2 of 2)",5,10);
  tft.drawString("BY RICARDO - GERT - RXAVIER",5, 20);
  tft.setTextColor(TFT_WHITE, TFT_BLACK);
...
//=======================================================================================
  ...
  tft.drawString("    ", XFreqDispl + 50, YFreqDispl + 18);
  si4735.getAutomaticGainControl();
  if (si4735.isAgcEnabled()) {
    tft.setTextColor(TFT_YELLOW, TFT_BLACK);
...
//=======================================================================================
  ...
  spr.pushSprite(240 - Xbatsiz, Ybatsiz*0);
  spr.deleteSprite();
